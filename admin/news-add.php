...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    insert("INSERT INTO news (title, slug, content, excerpt, image, category_id, featured, status) VALUES (?, ?, ?, ?, ?, ?, ?, ?)",
        [$title, $slug, $content, $excerpt, $image, $category_id, $featured, $status]);
...
<head>
    ...
    <title>Add News | Wish 107.5 Admin</title>
